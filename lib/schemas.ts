...
// Stałe jako readonly + typy wyprowadzane z nich:
...
export const REGISTERED_IN = ['EU', 'PL'] as const;
...
// (opcjonalnie możesz też wyeksportować typy wynikające ze stałych:)
...
export type RegisteredIn = typeof REGISTERED_IN[number];
export type SaleDocument = typeof SALE_DOCS[number];
