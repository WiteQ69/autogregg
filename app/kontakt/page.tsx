      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        >
          ...
          <p className="text-xl text-zinc-600 max-w-2xl mx-auto">
            Masz pytania o nasze samochody? Chcesz umówić się na oględziny? Napisz do nas!
          </p>
        </motion.div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-600">ul. Wenecja 6<br />34-100 Wadowice</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-zinc-900">9:00 - 18:00</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-600">Sobota</span>
                    <span className="font-medium text-zinc-900">10:00 - 16:00</span>
                  </div>
                  <div className="flex justify-between">
