...
export default function SprzedanePage() {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-zinc-600">
            Zobacz nasze ostatnie sprzedaże - może znajdziesz inspirację
          </p>
        </motion.div>
        ...
        {soldCars.length > 0 ? (
          ...
          >
            {soldCars.map((car, index) => (
              <motion.div key={car.id} layout className="relative">
          ...
          >
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-xl font-bold text-zinc-900 mb-2">Brak sprzedanych aut</h3>
              <p className="text-zinc-600">
                Jeszcze nie mamy historii sprzedaży do pokazania.
              </p>
            </div>
          </motion.div>
        )}
